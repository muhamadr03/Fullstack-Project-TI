...
const SidebarAdmin = ({ isCollapsed, toggleCollapse }) => {
    ...
    >
      <div className="d-flex align-items-center justify-content-between px-3 mb-4">
        ...
        <button
          ...
          className="collapse-btn d-none d-lg-flex border-0 text-muted"
        >
          <i
        ...
        <ul className="nav nav-pills flex-column mb-3">
          ...
          <li className="nav-item">
            ...
            >
              ...
              <span className="sidebar-text ms-2">Kelola Kategori</span>
            </NavLink>
          </li>
        </ul>
